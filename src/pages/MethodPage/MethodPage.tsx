      ...
      <Container maxWidth="md">
        ...
        <Box my={8}>
          <ContentSection
            ...
            content={[
              <div data-name="intro">Методика позволяет диагностировать субъективное состояние личности, означающее желание и способность заниматься данным видом профессиональной деятельности.
            ...
            <Box mb={4}>Достаточная выраженность этих компонентов - показатель высокого уровня готовности человека, его активности, самостоятельности в процессе деятельности.</Box>,
          ...
          <div data-name="diff">
              <ContentSection
                ...
                content={[
                  ...
                  <h2>Название типов профессий по столбцам:</h2>,
